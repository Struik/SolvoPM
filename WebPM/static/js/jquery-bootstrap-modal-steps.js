    ...
    $.fn.modalSteps = function(options) {
        ...
        $modal.on('show.bs.modal', function() {
            var $modalFooter = $modal.find('.modal-footer'),
                ...
                actualStep, $actualStep, titleStep, $titleStepSpan, nextStep;
            validCallbacks();
            ...
            $titleStepSpan = $('<span>').addClass('label label-default pull-right').html(actualStep);
        ...
        $modal.find('.js-btn-step').on('click', function() {
            var $btn = $(this),
                ...
                steps, nextStep, $nextStep, newTitle;
            ...
            var $titleStepSpan = $('<span>').addClass('label label-default pull-right').html(nextStep);
